...
class DemoNode: ASDisplayNode {
    ...
    let wishlistNode: ASDisplayNode = {
        let node = ASDisplayNode()
        node.automaticallyManagesSubnodes = true
    ...
    private func createBackgroundSpec() -> ASLayoutSpec {
        ...
        stackSpec.children = [seenNode, soldNode ,wishlistNode]
